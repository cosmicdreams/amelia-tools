...
The canonical source for the text below is references/coaching-contract.md (relative to this plugin). This everyday output style and the amelia-coach agent both load this same contract, so the two surfaces always agree; edit the canonical file once and regenerate both.
